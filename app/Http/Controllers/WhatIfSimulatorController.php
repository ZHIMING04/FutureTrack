...
class WhatIfSimulatorController extends Controller
{
    public function index()
    {
        ...
        $simulationData['navigationItems'] = [
            ...
            ['id' => 6, 'name' => 'What-If Simulator', 'href' => '/what-if-simulator', 'icon' => 'M9 7h6m0 10v-3m-3 3h.01M9 17h.01M9 14h.01M12 14h.01M15 11h.01M12 11h.01M9 11h.01M7 21h10a2 2 0 002-2V5a2 2 0 00-2-2H7a2 2 0 00-2 2v14a2 2 0 002 2z', 'active' => true],
    ...
    public function save(Request $request)
    {
        ...
        return back()->with('success', 'Simulation saved successfully');
    }
