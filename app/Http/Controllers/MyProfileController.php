...
class MyProfileController extends Controller
{
    public function index()
    {
        ...
        $profileData['navigationItems'] = [
            ...
            ['id' => 3, 'name' => 'My Profile', 'href' => '/my-profile', 'icon' => 'M16 7a4 4 0 11-8 0 4 4 0 018 0zM12 14a7 7 0 00-7 7h14a7 7 0 00-7-7z', 'active' => true],
    ...
    public function update(Request $request)
    {
        ...
        $request->validate([
            ...
            'current_education_level' => 'nullable|string|max:50',
        ...
        // Refresh the user data and return the updated profile
        $user = $user->fresh(['studentProfile', 'academicSubjects']);
