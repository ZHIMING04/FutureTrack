...
class ResourcesController extends Controller
{
    public function index(Request $request)
    {
        ...
        $resourceData['navigationItems'] = [
            ...
            ['id' => 11, 'name' => 'Resources', 'href' => '/resources', 'icon' => 'M8 7v8l4-4 4 4V7m0 3V7a2 2 0 00-2-2H6a2 2 0 00-2 2v10a2 2 0 002 2h8a2 2 0 002-2v-3m-4-3H8', 'active' => true],
        ...
        return Inertia::render('Resources', $resourceData);
    }
