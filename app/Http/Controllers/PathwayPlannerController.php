...
class PathwayPlannerController extends Controller
{
    public function index()
    {
        ...
        $pathwayData['navigationItems'] = [
            ...
            ['id' => 5, 'name' => 'Pathway Planner', 'href' => '/pathway-planner', 'icon' => 'M13 10V3L4 14h7v7l9-11h-7z', 'active' => true],
        ...
        return Inertia::render('PathwayPlanner', $pathwayData);
    }
