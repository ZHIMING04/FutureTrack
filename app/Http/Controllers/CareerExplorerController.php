...
class CareerExplorerController extends Controller
{
    public function index(Request $request)
    {
        ...
        $careerData['navigationItems'] = [
            ...
            ['id' => 4, 'name' => 'Career Explorer', 'href' => '/career-explorer', 'icon' => 'M21 13.255A23.931 23.931 0 0112 15c-3.183 0-6.22-.62-9-1.745M16 6V4a2 2 0 00-2-2h-4a2 2 0 00-2-2v2m8 0V6a2 2 0 012 2v6a2 2 0 01-2 2H6a2 2 0 01-2-2V8a2 2 0 012-2V6', 'active' => true],
        ...
        return Inertia::render('CareerExplorer', $careerData);
    }
